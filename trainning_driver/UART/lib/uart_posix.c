 ...
 **************************************************************************************************/
static int32_t uartOpenSerial(char* device, uint32_t bps, uint32_t dataBits, uint32_t parity,
...
int signal_handler_IO (int status); /* definition of signal handler */
                              ...
                              uint32_t stopBits, uint32_t rtsCts, uint32_t xOnXOff, int32_t timeout)
{
  ...
  fcntl(serial, F_SETOWN, getpid());  /** Owner this socket **/
  fcntl(serial, F_SETFL,  O_ASYNC ); /**<<<<<<------This line made it work.**/
